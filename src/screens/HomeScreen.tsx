import { View, ScrollView, Image, Pressable, StyleSheet, Animated } from 'react-native';
...
export default function HomeScreen({ navigation }: Props) {
  ...
  useFocusEffect(useCallback(() => { setTabBarVisible(true); }, [setTabBarVisible]));
