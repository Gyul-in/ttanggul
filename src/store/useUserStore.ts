...
interface UserState {
  ...
  hasRequestedExactAlarm: boolean;
  setHasRequestedExactAlarm: (value: boolean) => void;
...
export const useUserStore = create<UserState>()(
  persist(
    (set) => ({
      ...
      setHasRequestedExactAlarm: (value) => set({ hasRequestedExactAlarm: value }),
